...
class CffiExportStructure(object):
    ...
    '''
        ...
        cpp_python = ffi.dlopen(r'D:\Visual_Studio_Projects\cpp_python_vs\Debug\cpp_python_vs.dll')
    ...
    def pass_python_bytes_string(self, bytes_string):
        ...
        #TODO print bytes_string address
    ...
    def out_memory_python_noalloc(self):
        ...
        io_print(u'从 cpp 返回的字符串内存地址 {}'.format(ptr[0]))
    ...
    def out_memory_python_alloc(self):
        ...
        if hr == 0 and size[0]>0:
            ...
            io_print(u'提供申请的字符串内存地址 {}'.format(self._cffi_ins.addressof(ptr)[0]))
            hr = pfn(ptr,size)
            if hr == 0 and size[0]>0:
                # not use ptr[0]
